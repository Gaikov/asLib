 ...
 * Date: 10.02.12
 */
package com.grom.lib.scene
{
import flash.display.DisplayObject;
import flash.display.Sprite;

import com.grom.lib.scene.transition.ISceneTransition;
...
import com.grom.lib.scene.event.SceneEvent;

import com.grom.lib.scene.transition.IScenePlacer;
...
class ScenePlacer implements IScenePlacer
{
	...
	public function ScenePlacer(oldScene:DisplayObject, newScene:DisplayObject, sceneRoot:Sprite, onSceneChanged:Function)
	{
		...
		if (_oldScene)
		{
			UDisplay.disableMouse(_oldScene);
		}
	}
